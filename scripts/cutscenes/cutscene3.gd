...
var objective = "[color=red]22,122 hrs since the crash[/color]\n\n While travelling through a Astroid belt Axton encountered a swarm of magnetic astroids, however his sheilds are still on repair, help Axton survive till the sheilds come back online."
